...
### Methodology: murine framework regions were replaced with human framework regions.  Framework residues were selectively mutated back to the murine counterpart in order to support CDR functionality/ structure.
### Reference file: Chimeric_Fv_complete_set.pdb
