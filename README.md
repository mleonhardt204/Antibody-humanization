...
### Step 1: Sequences underwent initial “humanness” assessment required to select the ideal human light and human heavy chain acceptors.

### Step 2:  Human framework regions were grafted on to the CDR regions of Murine_Fv_V_Domain_Clean.pdb.  Atomic coordinates of chimeric Fv are contained within: chimeric_Fv.pdb

### Step 3: to get a visualization of chimeric_Fv: 
...
### Step 4: potential framework back-mutations were noted and prioritized (based on the physical support provided to CDRs within the murine Fv).  However, if the equivalent human framework residues (within the chimeric_Fv) also provided physical support to the CDRs, then back-mutation was de-prioritized. Internal structure analyzed:
...
### Step 5: assessment of mutated chimeric_Fv molecules:
...
### Step 6: visualization of final construct:  Chimeric_Fv_complete_set.pdb
