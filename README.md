...
### <ins>Step 1</ins>: 
#### Sequences underwent initial “humanness” assessment required to select the ideal human light and human heavy chain acceptors.
...
### <ins>Step 4</ins>: 
#### Potential framework back-mutations were noted and prioritized (based on the physical support provided to CDRs within the murine Fv).  However, if the equivalent human framework residues (within the chimeric_Fv) also provided physical support to the CDRs, then back-mutation was de-prioritized. Internal structure analyzed:
...
### <ins>Step 5</ins>: 
#### Assessment of mutated chimeric_Fv molecules:
...
### <ins>Step 6</ins>: 
#### Visualization of final construct:  Chimeric_Fv_complete_set.pdb
